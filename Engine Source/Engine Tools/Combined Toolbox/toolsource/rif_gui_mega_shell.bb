...
Global PrevMenuItem.window=gui_addwindow("Preview",menu.window,.25,.011,.1,.025,df_button,16,button,255,255,255,1,0)
...
Global GridMenuItem.window=gui_addwindow("Grid",menu.window,.58,.011,.1,.025,df_button,16,button,255,255,255,1,0)
;----------------------------------------File Dropdown menu
Global RCFile.window=gui_createwindow("File",0,.051,.15,.3,32,32,1,0,mainwindow,255,255,255,1)
...
;----------------------------------------Edit Dropdown menu
Global RCEdit.window=gui_createwindow("Edit",.115,.051,.15,.42,32,32,1,0,mainwindow,255,255,255,1)
...
Global RCFileDivider4.window=gui_addwindow("",RCedit.window,.013,.36,.125,.005,df_button,16,label,255,255,255,1,0)
;-
;Global MegaEffectLABEL.window=gui_addwindow("Effect All",RCEdit.window,.035,.375,.08,.03,df_button,16,LABEL,255,255,255,1,0)
;Global MegaEffectCheck.window=gui_addwindow("",RCEdit.window,.119,.38,.02,.02,df_button,16,checkbox,255,255,255,1,0)
;gui_setstatus(MegaEffectCheck.window,1)
Gui_SetWindowGroup(RCEdit.window,EditMenuItem.window,"menus",2,1)
;----------------------------------------Lightmap Options Window
Global LightmapOPtions.window=gui_complexwindow("Lightmap",.3,.3,.3,.3,128,32,1,0,mainwindow,255,255,255,1)
Global LmWARNING.window=gui_addwindow(".",LightMapOptions.window,.012,.028,.28,.07,256,64,canvas,0,0,0,1,0)
tempfont=LoadFont("ariel",18,True)
tempimage=CreateImage(256,64)
SetBuffer ImageBuffer(tempimage)
SetFont tempfont
Color 255,0,0
Rect 0,0,256,64,False
Text(5,3, "Warning: Lightmapping can take up")
Text(5,22,"to 20 minutes .Depending on")
Text(5,41,"terrain complexity.")
SetBuffer BackBuffer()
SaveImage tempimage,"gui_temp.bmp"
gui_loadtexture(lmwarning.window,"gui_temp.bmp")
FreeImage tempimage
DeleteFile "gui_temp.bmp"

FreeFont tempfont
;-
Global LmAmbLabal.window=gui_addwindow("Ambient",LightMapOptions.window,.05,.12,.08,.03,df_button,16,label,255,255,255,1,0)
Global MornLabal.window=gui_addwindow("Morning",LightMapOptions.window,.14,.12,.08,.03,df_button,16,label,255,255,255,1,0)
Global AftLabal.window=gui_addwindow("Afternoon",LightMapOptions.window,.14,.16,.08,.03,df_button,16,label,255,255,255,1,0)
Global EveLabal.window=gui_addwindow("Evening",LightMapOptions.window,.14,.2,.08,.03,df_button,16,label,255,255,255,1,0)
;Global LmSmthLabal.window=gui_addwindow("Smoothing",LightMapOptions.window,.16,.12,.08,.03,df_button,16,label,255,255,255,1,0)
Global LightmapAmbient.spinner= Gui_CreateSpinner(.05,.16,.08,.03,1,127,80,LightMapOptions.window)
Global LightMornCheck.window=gui_addwindow("",LightmapOptions.window,.23,.125,.02,.02,df_button,16,checkbox,255,255,255,1,0)
Global LightAfternoonCheck.window=gui_addwindow("",LightmapOptions.window,.23,.165,.02,.02,df_button,16,checkbox,255,255,255,1,0)
Global LightNightCheck.window=gui_addwindow("",LightmapOptions.window,.23,.205,.02,.02,df_button,16,checkbox,255,255,255,1,0)
gui_setgroup(Lightmorncheck.window,121)
gui_setgroup(Lightafternooncheck.window,121)
gui_setgroup(Lightnightcheck.window,121)
gui_Setstatus(Lightafternooncheck.window,1)
;Global LightmapSmooth.spinner= Gui_CreateSpinner(.16,.16,.08,.03,0,20,2,LightMapOptions.window)
;-
;Global LmCombo.combobox= gui_CreateComboBox("Time",.06,.175,.15,.05,128,16,lightmapoptions.window)
;Gui_ComboAdditem ("Morning",LmCombo.combobox)
;Gui_ComboAdditem ("Late morning",LmCombo.combobox)
;Gui_ComboAdditem ("Noon",LmCombo.combobox)
;Gui_ComboAdditem ("Afternoon",LmCombo.combobox)
;Gui_ComboAdditem ("Evening",LmCombo.combobox)
;Gui_settext(Lmcombo\combooutput.window,"Noon")
;-
Global lightmapOK.window=gui_addwindow("Ok",LightmapOptions.window,.04,.25,.1,.03,df_button,16,button,255,255,255,1,0)
Global lightmapCancel.window=gui_addwindow("Cancel",LightmapOptions.window,.158,.25,.1,.03,df_button,16,button,255,255,255,1,0)
;----------------------------------------Help Dropdown menu
;Global RCHelp.window=gui_createwindow("Help",.34,.051,.15,.12,32,32,1,0,mainwindow,255,255,255,1)
...
SetBuffer BackBuffer()
SaveImage tempimage, "gui_temp1.bmp"
gui_loadtexture(controlinfo.window,"gui_temp1.bmp")
DeleteFile "gui_temp1.bmp"
;----------------------------------------About info window
...
;----------------------------------------Tree Selection Menu
Global Treeoption.window=gui_createwindow("TreeOPtion",.4,.25,.3,.35,32,32,1,0,mainwindow,255,255,255,1)
...
;----------------------------------------MegaGrid
Global MegaGridWindow.window=gui_Createwindow("Mega Grid",.55,.6,.245,.3,32,32,1,0,mainwindow,255,255,255,1)
Global MegaGridButton.window=gui_addwindow("1",MegaGridWindow.window,.02,.02,.2,.2,128,128,button,255,255,255,1,0)
gui_loadtexture(Megagridbutton.window,"data\rcte\megagrid.png")
Gui_SetWindowGroup(MegaGridWindow.window,GridMenuItem.window,"megagrid",1,1)
Global megachangex.spinner= Gui_CreateSpinner(.02,.225,.08,.03,0,7,0,MegaGridWindow.window)
Global megachangey.spinner= Gui_CreateSpinner(.104,.225,.08,.03,0,7,0,MegaGridWindow.window)

Global megachangex2.spinner= Gui_CreateSpinner(.02,.26,.08,.03,0,7,7,MegaGridWindow.window)
Global megachangey2.spinner= Gui_CreateSpinner(.104,.26,.08,.03,0,7,7,MegaGridWindow.window)

Global MegaGridGO.window=gui_addwindow("Go",MegaGridWindow.window,.19,.225,.04,.03,64,16,Button,255,255,255,1,0)
Global MegaGridTO.window=gui_addwindow("Area",MegaGridWindow.window,.19,.26,.04,.03,32,16,label,255,255,255,1,0)

;Global megachangex.spinner= Gui_CreateSpinner(.035,.225,.08,.03,0,9,0,MegaGridWindow.window)
;Global megachangey.spinner= Gui_CreateSpinner(.135,.225,.08,.03,0,9,0,MegaGridWindow.window)
;Global MegaGridGO.window=gui_addwindow("Go",MegaGridWindow.window,.09,.257,.07,.03,64,16,Button,255,255,255,1,0)
