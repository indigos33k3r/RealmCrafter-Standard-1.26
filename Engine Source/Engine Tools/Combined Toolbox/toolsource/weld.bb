...
For t=0 To CountVertices(su)-1
	If VertexX(su,t)>=(x2-.001) And VertexX(su,t)<=(x2+.001) Then 
		If VertexY(su,t)>=(y2#-.001) And VertexY(su,t)<=(y2+.001) Then 
			If VertexZ(su,t)>=(z2#-.001) And VertexZ(su,t)<=(z2+.001) Then 
