...
; Program: Realm Crafter Client Net module
;
...
;HISTORY:
;
;Ability fix 8/1/2007 Rofar: added spell ID to message from server for Known Spell update. Also, added new known spell to 
;SpellList in same handler.
;Actor moves/change areas standard update timing fix. 8/16/2007 Rofar.  added IgnoreUpdate field handling in AI																																
