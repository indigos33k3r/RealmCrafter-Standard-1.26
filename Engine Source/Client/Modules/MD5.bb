...
; Array used by the MD5 function
Dim MD5_x(0)
...
Function MD5$(sMessage$)
	...
	BlockNum = ((Len(sMessage$) + 8) Shr 6) + 1 ; Number of 16-word blocks
	Dim MD5_x(BlockNum * 16 - 1)
	...
	MD5_x(BlockNum * 16 - 2) = Len(sMessage$) * 8
	...
	For k = 0 To (BlockNum * 16 - 1) Step 16
		MD5_AA = MD5_a
		MD5_BB = MD5_b
		MD5_CC = MD5_c
		MD5_DD = MD5_d
